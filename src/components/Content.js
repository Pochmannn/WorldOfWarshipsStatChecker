...
class Content extends React.Component{
    ...
    render() {
        return(   
            ...
            <form className="mt-3 ml-3" onSubmit={this.onFormSubmit}>
                <label class="text-black italic font-black  ml-auto mr-auto text-2xl">Wpisuj nick swój panie kolego: </label>
                <input type="text" className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" onChange={this.onInputChange} value={this.state.nickname}/> Pierdolnij enter żeby pokazać staty ( nie działa na razie przykro mi)
            </form>
            <MainStats />
