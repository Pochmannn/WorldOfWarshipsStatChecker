function Footer(){
    return(
        <footer className="bg-gray-800 text-4xl items-center text-white w-full flex justify-left h-20 bottom-0 left-0 right-0"> 
            ...
            <img alt="" className="h-16 mr-0 fixed right-4 " src="https://upload.wikimedia.org/wikipedia/commons/3/34/Gmod_logo.png"/>            
